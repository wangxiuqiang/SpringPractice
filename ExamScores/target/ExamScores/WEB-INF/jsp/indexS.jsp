...
<div class="FormDiv">
    ...
    <form:form commandName="joinTS" id="joinTS" action="${pageContext.request.contextPath}/tsJoin_in/0" method="post">
        <table>
            <tr>
                <td>
                    <p>
                        用户名: <form:input class="tText" path="id" placeholder="请输入学号"  htmlEscape="true" autofocus="autofocus" accesskey="t"/>
                    </p>
                </td>
            </tr>
            <tr>
