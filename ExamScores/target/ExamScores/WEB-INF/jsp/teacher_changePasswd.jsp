                    ...
                    <div class="pricing-table">
                        <div class="pricing-header">
                            ...
                            <table cellpadding="5">
                                ...
                                <tr>
                                    <td>编号:</td>
                                    <td><form:input path="id" maxlength="8" size="16" htmlEscape="true" style="width:150px;"/></td>
                                </tr>

                                <tr>
                                    <td>新密码:</td>
                                    <td><form:password path="password" maxlength="8" size="16" htmlEscape="true" style="width:150px;"/></td>
                                </tr>
                                <tr>
                                    <td>确认密码:</td>
                                    <td><form:password path="name" maxlength="8" size="16" htmlEscape="true" style="width:150px;"/></td>
                                </tr>
                                <tr>
